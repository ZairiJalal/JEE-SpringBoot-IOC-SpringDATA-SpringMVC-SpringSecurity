...
public class BanqueController {    //ceci est un controlleur Spring MVC
 ...
 //la couche web a besoin de la couche metier --> d'où
	...
	public String consulterCompte(Model model, Long codeCompte) {   //cette methode retourne une vue tous simplement
		...
		try {
			...
			List<Operation>  pageOperations = iBanqueMetier.listOperationsCompte(codeCompte );
			model.addAttribute("listOperations",pageOperations);
	...
	public String saveOperation(Model model,String typeOperation, Long codeCompte,double montant, Long codeCompte2) {   //cette methode retourne une vue tous simplement
